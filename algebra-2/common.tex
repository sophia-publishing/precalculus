...
% reduce occurrences of float pages
\renewcommand{\floatpagefraction}{.7}
\renewcommand{\topfraction}{.9}
\renewcommand{\textfraction}{.05}

% Page style for float pages (no header/footer)
...
% Activate it on float-only pages
...
\NewDocumentCommand\trans{o m}
    {\IfNoValueTF {#1}%
        {\arrow[d, "\text{\shortstack[c]{#2}}"] \\}%
        {\arrow[d, "\text{\shortstack[c]{#1}}"', "\text{\shortstack[c]{#2}}"] \\}
    }
