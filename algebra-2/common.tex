...
\usepackage{sidenotesplus}[size=normal,ragged]
...
\newcommand{\xincludegraphics}[1]{\includegraphics[width=50mm]{#1}}

\newcommand{\mexinstr}[1]{\sidenote*{#1\medskip}}
