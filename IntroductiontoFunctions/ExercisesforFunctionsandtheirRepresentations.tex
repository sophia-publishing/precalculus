...
\begin{tasks}[resume](2)
\task \label{graphfunctionfirstxy}
\begin{adjustbox}{valign=t}
...
\task \label{graphfunctionfirstxy2}
\begin{adjustbox}{valign=t}
...
\task \label{graphfunctionfirstxy3}
\begin{adjustbox}{valign=t}
...
\task \label{graphfunctionfirstvw}  
\begin{adjustbox}{valign=t}
...
\task \label{graphfunctionfirstvw2} 
\begin{adjustbox}{valign=t}
...
\task \label{graphfunctionfirstvw3} 
...
\task \label{graphfunctionfirsttT}
\begin{adjustbox}{valign=t}
...
\task  \label{graphfunctionfirsttT2}
...
\task \label{graphfunctionfirsttT3}
...
\begin{shortexenum}[$f(x) = x(x-1)(x+2)$]
