...
\begin{ex}  \label{functiongraphex01} Consider the graph in \autoref{fig:fun:weqfv}.  
...
Pictures showing the projection of the graph onto the $w$-axis are given in \autoref{fig:findingtherange}.
...
\end{multicols}
\caption{Finding the range}
\label{fig:findingtherange}
\end{center}
\end{figure}
...
\input{ExercisesforFunctionsandtheirRepresentations}
