...
\task \label{findformulaforabsgraphfirst}
...
\task \label{findformulaabsgraphlast}
\begin{adjustbox}{valign=t}
\begin{mfpic}[13]{-5}{5}{-5}{5}
\axes
\tlabel[cc](5,0.5){\scriptsize $x$}
