...
\item  $g(t) = \dfrac{t^{2} - 2t + 1}{t^{3} + t^{2} - 2t}$ \label{sixsteplast}
\mexinstr{%
    Once you've done the six-step procedure, use a graphing utility to graph this function on the window $[0, 12] \times [0, 0.25]$ \ldots
}
...
\item \label{rationalfromgraphfirst} $y = f(x)$. See \autoref{fig:vaxequalstwo}.

\begin{mfigure}

\begin{mfpic}[15]{-2}{6}{-4}{4}
\axes
\point[4pt]{(1,-1), (3,1)}
...
\caption{}
\label{fig:vaxequalstwo}
\end{mfigure}


\item $y = F(x)$. See \autoref{fig:vaxequalstwowithhole}
...
\caption{}
\label{fig:vaxequalstwowithhole}
\end{mfigure}

\item $y = g(t)$. See \autoref{fig:sayequalst}
...
\caption{}
\label{fig:rzeqzbyzsquaredetc}
\end{mfigure}

\item 
$f(x) =  4x(x^2+4)^{-1} = \dfrac{4x}{x^{2} + 4}$\\
Domain: $(-\infty,  \infty)$\\
$x$-intercept:  $(0,0)$\\
$y$-intercept:  $(0,0)$\\
...
As $x \rightarrow -\infty, f(x) \rightarrow 0^{-}$\\
As $x \rightarrow \infty, f(x) \rightarrow 0^{+}$\\
See \autoref{fig:fxeqfourxintoxsquaredetc}

\begin{mfigure}

\begin{mfpic}[6][25]{-8}{8}{-2}{2}
\point[4pt]{(0,0)}
...
\item
$g(t) = 3- \dfrac{5t-25}{t^2-9} = \dfrac{3t^2-5t-2}{t^{2} -9} = \dfrac{(3t+1)(t-2)}{(t + 3)(t - 3)}$\\
...
As $t \rightarrow \infty, g(t) \rightarrow 3^{-}$\\
See \autoref{fig:gteqthreeminusfiveetc}

\begin{mfigure}

\begin{mfpic}[6]{-10}{10}{-10}{10}
...
\caption{}
\label{fig:fxeqfivexbynineetc}
\end{mfigure}

\item 
$g(t) = \dfrac{1}{2}t-1 + \dfrac{t+1}{t^2+1} = \dfrac{t(t^2-2t+3)}{2t^2+2}$\\
Domain: $(-\infty,\infty)$\\
$t$-intercept: $(0,0)$\\
$y$-intercept:  $(0,0)$\\
...
See \autoref{fig:gteqonebytwotetc}
