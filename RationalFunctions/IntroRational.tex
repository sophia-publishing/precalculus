...
\tcaption{\scriptsize $y = \left(x - \frac{3}{2} \right)^{-2}$; \newline $\left(\frac{1}{2} ,1 \right)$, VA: $x = \frac{3}{2}$, $\left(\frac{5}{2} ,1 \right)$}
\end{mfpic}
...
\arrow \reverse \arrow \function{1.8333,6.5,0.1}{1/((x-1.5)**2)}
\point[4pt]{(0.5,1), (2.5,1)}
\tcaption{\scriptsize $y = \left(x - \frac{3}{2} \right)^{-2}$; \newline $\left(\frac{1}{2} ,1 \right)$,  $\left(\frac{5}{2} ,1 \right)$}
\end{mfpic} 
...
\tcaption{\scriptsize $y = \frac{1}{4} \left(x - \frac{3}{2} \right)^{-2}$; \newline $\left(\frac{1}{2} ,\frac{1}{4} \right)$,  $\left(\frac{5}{2} , \frac{1}{4} \right)$}
\end{mfpic}
...
\tcaption{\scriptsize $y =P(t)$; \newline $\left(4, 100 \right)$, VA: $t = 5$}
\end{mfpic}
...
\tcaption{\scriptsize $y=N(t)$; \newline $\left(\frac{2}{3},350 \right)$, HA: $y = 500$}
\end{mfpic}
