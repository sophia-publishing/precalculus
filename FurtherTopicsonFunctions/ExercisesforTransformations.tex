...
\task \label{findformulatransformationlast} $y = s(x)$ % $s(x) = 2f(-x+1)-3 = -2f(x-1)+3$  
...
\task $j(x) = f\left(x - \frac{2}{3}\right)$\\
...
\task $k(x) = f\left(\frac{2}{3}x\right)$\\
...
\task \small $q(x) = -\frac{1}{2}f\left(\frac{x + 4}{2}\right) - 3 = -\frac{1}{2}f\left( \frac{1}{2}x + 2 \right) - 3 $\\ \normalsize
