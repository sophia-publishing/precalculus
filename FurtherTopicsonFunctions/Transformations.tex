...
&
	...
	\stackrel{\transgraph{0.5in}{shift up $2$ units}}{\text{\parbox{0.5in}{\centering \scriptsize add $2$ to each $y$-coordinate}}}
...
\end{mfpic}
\\
\stackrel{\transgraph{1in}{shift left $2$ units}}{\parbox{1in}{\centering \scriptsize subtract $2$ from each $x$-coordinate}} 
%
...
\includegraphics[width=3in]{./TransformationsGraphics/TransformationsEx01a.jpg}
...
\end{mfpic}
\\
\stackrel{\transgraph{1in}{shift right  $2$ units}}{\mbox{ \scriptsize add $2$ to each $x$-coordinate}} 
%
\begin{adjustbox}{valign=c}
\begin{mfpic}[15]{-3}{8}{-1}{5}
\axes
...
\end{mfpic}
\\
\stackrel{\transgraph{1in}{shift up $1$ unit}}{\mbox{ \scriptsize add $1$ to each $y$-coordinate}} 
%
\begin{adjustbox}{valign=c}
\begin{mfpic}[15]{-3}{6}{-1}{6}
\axes
...
\end{mfpic}
\\
\stackrel{\transgraph{1in}{shift left $1$ unit}}{\mbox{ \scriptsize subtract $1$ from each $x$-coordinate}} 
%
\begin{adjustbox}{valign=c}
\begin{mfpic}[15]{-4}{6}{-1}{5}
\axes
...
Next, we apply Theorem \ref{vshifts}  to graph $y = f(x+1)-2$ starting with the graph of $y=f(x+1)$.  Writing $f(x+1)-2=f(x+1)+(-2) = f(x+1)+k$, we identify $k=-2$ so  Theorem \ref{vshifts} instructs us to add $-2$ to (subtract $2$ from) each of the $y$-coordinates on the graph of $y = f(x+1)$, thereby shifting the graph \textit{down} two units. See \autoref{fxplusonetofxplusoneminustwo}.
...
\end{mfpic}
\\
\stackrel{\transgraph{1in}{shift down $2$ units}}{\mbox{ \scriptsize subtract $2$ from each $y$-coordinate}} 
%
\begin{adjustbox}{valign=c}
\begin{mfpic}[15]{-4}{6}{-3}{5}
\axes
...
\end{adjustbox}
%
\stackrel{\transgraph{0.75in}{reflect across $x$-axis}}{\parbox{0.5in}{\centering \scriptsize multiply each $y$-coordinate by $-1$}} 
%
\begin{adjustbox}{valign=c}
\begin{mfpic}[14]{-1}{6}{-6}{6}
...
\end{mfpic}
\\
\transgraphtwo{1in}{reflect across $y$-axis}{multiply each $x$-coordinate by $-1$} 
%
\begin{adjustbox}{valign=c}
\begin{mfpic}[13]{-6}{6}{-1}{6}
\tlabel[cc](1,1){\scriptsize $(0,1)$}
...
\includegraphics[width=3in]{./TransformationsGraphics/TransformationsEx02a.jpg}
...
\end{mfpic}
\\
\transgraphtwo{1in}{shift up $1$ unit}{add $1$ to each $y$-coordinate} 
%
\begin{adjustbox}{valign=c}
\begin{mfpic}[15]{-3}{3}{-1}{6}
\axes
...
\end{adjustbox}
%
\transgraphtwo{1in}{shift left $2$ units}{subtract $2$ from each $x$-coordinate} 
%
\begin{adjustbox}{valign=c}
...
\end{adjustbox}
\\
\transgraphtwo{1in}{reflect about the $y$-axis}{multiply each $x$-coordinate by $-1$} 
%
\begin{adjustbox}{valign=c}
...
\end{adjustbox}
%
\transgraphtwo{1in}{reflect about the $x$-axis}{multiply each $y$-coordinate by $-1$}
%
\begin{adjustbox}{valign=c}
...
\end{adjustbox}
%
\transgraphtwo{1in}{shift up $1$ unit}{add $1$ to each of the $y$-coordinates}
%
\begin{adjustbox}{valign=c}
...
\end{adjustbox}
%
\transgraphtwo{0.75in}{vertical scaling by a factor of $2$}{multiply each $y$-coordinate by $2$}
%
\begin{adjustbox}{valign=c}
\begin{mfpic}[15]{-1}{6}{-1}{11}
...
If we wish to graph $y = \frac{1}{2} f(x)$, we multiply the all of the $y$-coordinates of the points on the graph of $f$ by $\frac{1}{2}$.  This creates a `vertical scaling\footnote{Also called `vertical shrink,' `vertical compression' or `vertical contraction' by a factor of $2$.} by a factor of $\frac{1}{2}$' as seen in \autoref{fig:yeqfxtoyeqhalffx}.
...
\end{adjustbox}
%
\transgraphtwo{0.75in}{vertical scaling by a factor of $\frac{1}{2}$ }{multiply each $y$-coordinate by $\frac{1}{2}$}
%
\begin{adjustbox}{valign=c}
\begin{mfpic}[15]{-1}{6}{-1}{6}
...
\end{adjustbox}
%
\transgraphtwo{0.75in}{horizontal scaling by a factor of $\frac{1}{2}$}{multiply each $x$-coordinate by $\frac{1}{2}$} 
%
\begin{adjustbox}{valign=c}
\begin{mfpic}[15]{-1}{6}{-1}{6}
\tlabel[cc](-1,1){\scriptsize $(0,1)$}
...
\end{adjustbox}
\\
\transgraphtwo{1in}{horizontal scaling by a factor of $2$}{multiply each $x$-coordinate by $2$} 
%
\begin{adjustbox}{valign=c}
\begin{mfpic}[12]{-1}{11}{-1}{6}
\tlabel[cc](-1,1){\scriptsize $(0,1)$}
...
\begin{minipage}{\linewidth}
	\scriptsize \textbf{NOTE:}  The $y$-axis, $x=0$, is a vertical asymptote
	to the graph of $y = f(x)$ and the line $x=2$ is a vertical asymptote to
	the graph of $y = g(x)$.
\end{minipage}
\end{center}
...
\includegraphics[width=3in]{./TransformationsGraphics/TransformationsEx03a.jpg}
...
\end{mfpic}
\\
\transgraphtwo{1in}{vertical scaling by a factor of $\frac{1}{2}$}{multiply each $y$-coordinate by $\frac{1}{2}$} 
%
\begin{adjustbox}{valign=c}
\begin{mfpic}[15]{-1}{6}{-3}{3}
\axes
...
\end{adjustbox}
\\
\transgraphtwo{0.75in}{reflect about the $x$-axis }{multiply each $y$-coordinate by $-1$} 
%
\begin{adjustbox}{valign=c}
\begin{mfpic}[15]{-1}{6}{-3}{3}
\axes
...
Finally, we shift the graph of $y = -\frac{1}{2} f(x)$ vertically up $\frac{1}{2}$ unit by adding $\frac{1}{2}$ to each of the $y$-coordinates of each of the points to obtain the graph of $y = -\frac{1}{2}f(x)+\frac{1}{2} = F(x)$. See \autoref{fig:}.
...
\end{adjustbox}
%
\transgraphtwo{0.75in}{shift up $\frac{1}{2}$ unit}{add $\frac{1}{2}$ to each $y$-coordinate}
%
\begin{adjustbox}{valign=c}
\begin{mfpic}[15]{-1}{6}{-3}{3}
\axes
...
\end{mfpic}
%
\transgraphtwo{0.75in}{reflect across the $x$-axis }{multiply each $y$-coordinate by $-1$} 
%
\begin{mfpic}[15]{-1}{6}{-3}{3}
\axes
\tlabel[cc](6,-0.5){\scriptsize $x$}
...
\end{adjustbox}
\\
\transgraphtwo{1in}{shift left $\frac{1}{2}$ unit}{subtract $\frac{1}{2}$ from each $x$-coordinate} 
%
\begin{adjustbox}{valign=c}
...
\end{adjustbox}
\\
\transgraphtwo{1in}{horizontal scaling by a factor of $2$ }{multiply eac $x$-coordinate by $2$} 
%
\begin{adjustbox}{valign=c}
...
\end{adjustbox}
\\
\transgraphtwo{0.75in}{horizontal scaling by a factor of $2$}{multiply each $x$-coordinate by $2$} 
%
\begin{adjustbox}{valign=c}
...
\includegraphics[width=3in]{./TransformationsGraphics/TransformationsEx04a.jpg}
...
\includegraphics[width=3in]{./TransformationsGraphics/TransformationsEx04c.jpg}
...
\includegraphics[width=3in]{./TransformationsGraphics/TransformationsEx04e.jpg}
...
\input{ExercisesforTransformations}
