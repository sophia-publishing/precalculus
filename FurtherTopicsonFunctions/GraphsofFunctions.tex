...
\item To solve $(t^2-25) g(t) = 0$, we use the zero product property of real numbers\footnote{see Section \ref{AppRealNumberArithmetic}, \pageref{box:propertiesofzero}} to conclude either $t^2-25 = 0$ or $g(t) = 0$.  
...
\input{ExercisesforGraphsofFunctions}
