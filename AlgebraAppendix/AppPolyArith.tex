...
\item  We begin `distributing the negative' as indicated on page \pageref{propertiesofnegatives} in Section \ref{AppRealNumberArithmetic}, then we rearrange and combine like terms:
\begin{align*}
...
\input{ExercisesforAppPolyArith}
