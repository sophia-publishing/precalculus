...
Certain subsets of the real numbers are worthy of note and are listed in \autoref{setsofnumbersboxonthispage}.  In fact, in more advanced texts,\footnote{See, for instance, Landau's \underline{Foundations of Analysis}.}   the real numbers are \textit{constructed} from some of these subsets.  

\begin{floatbox}{Special Subsets of Real Numbers}
...
\input{ExercisesforAppSetTheory}
