...
\begin{tasks}(2)
\task \label{reviewsubelim1}
$\left\{ \begin{array}{rcr} 2x - y & = & 1 \\ y & = & 3 \\ \end{array} \right.$ \vphantom{$\left\{ \begin{array}{rcr} \frac{x}{3} -\frac{4y}{5} & = & \frac{7}{5} \\ [3pt] 
\frac{2x}{9} + \frac{y}{3} & = & \frac{1}{2} \\ \end{array} \right.$}

\task \label{reviewsubelim2}
$\left\{ \begin{array}{rcr} 3x+4y & = & -2  \\ -3x-y & = & 5 \\ \end{array} \right.$ \vphantom{$\left\{ \begin{array}{rcr} \frac{x}{3} -\frac{4y}{5} & = & \frac{7}{5}\\[3pt] \frac{2x}{9} + \frac{y}{3} & = & \frac{1}{2} \\ \end{array} \right.$}

\task \label{reviewsubelim3}
 $\left\{ \begin{array}{rcr} \frac{x}{3} -\frac{4y}{5} & = & \frac{7}{5} \\ [3pt] 
\frac{2x}{9} + \frac{y}{3} & = & \frac{1}{2} \\ \end{array} \right.$

\task \label{reviewsubelim4}
 $\left\{ \begin{array}{rcr} 2x - 4y & = & 6 \\ 3x -6y & = & 9\\ \end{array} \right.$ \vphantom{$\left\{ \begin{array}{rcr} x - y & = & 0 \\ x + y & = & 2 \\ -2x + y & = & -2 \end{array} \right.$}

\task  \label{reviewsubelim5}
$\left\{ \begin{array}{rcr} 6x + 3y & = & 9 \\ 4x + 2y & = & 12 \\ \end{array} \right.$ \vphantom{$\left\{ \begin{array}{rcr} x - y & = & 0 \\ x + y & = & 2 \\ -2x + y & = & -2 \end{array} \right.$}

\task  \label{reviewsubelim6}
...
\caption{Graphing solution for Example \ref{reviewsubelim} Problem \ref{reviewsubelim1} and \ref{reviewsubelim2}}
\label{fig:exampsoe2}
\end{center}
\end{figure}
...
\caption{Graphing solution for Example \ref{reviewsubelim} Problem \ref{reviewsubelim2} and \ref{reviewsubelim4}}
\label{fig:exampsoe3}
\end{center}
\end{figure}
...
\caption{Graphing solution for Example \ref{reviewsubelim} Problem \ref{reviewsubelim5} and \ref{reviewsubelim6}}
\label{fig:exampsoe4}
\end{center}
\end{figure}
...
\input{ExercisesforAppLinearSystems}
