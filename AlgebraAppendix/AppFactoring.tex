...
\begin{floatbox}{Finding the G.C.F. of a Polynomial Expression}
\label{PolynomialGCF}
...
\begin{floatbox}{Common Factoring Formulas}
...
\begin{floatbox}{Additional Factoring Formulas}
...
\begin{floatbox}{Strategy for Solving Non-linear Equations}
...
\input{ExercisesforAppFactoring}
