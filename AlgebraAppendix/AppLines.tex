...
$ m = \dfrac{-1 - 3}{2.1 - 2} = \dfrac{-4}{0.1}=-40$ 
...
\caption{slope $= \frac{\mbox{\small rise}}{\mbox{\small run}} = \frac{1}{2}$}
\label{fig:raisetorun}
\end{center}
\end{figure}
...
\caption{Answer for Example \ref{ex1graphline} Problem \ref{ex1graphline1}}
\label{fig:graphinglines}
\end{center}
\end{figure}
