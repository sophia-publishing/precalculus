...
\begin{defn} \label{modulusargumentdefn} \textbf{The Modulus and Argument of Complex Numbers:} 
...
\begin{defn} \label{polarformcomplex} \index{complex number ! polar form ! cis-notation} \index{polar form of a complex number} \textbf{A Polar Form of a Complex Number:} 
...
\begin{thm} \label{prodquotpolarcomplex} \textbf{Products, Powers and Quotients Complex Numbers in Polar Form:}  
...
\colorbox{ResultColor}{\bbm
\begin{thm} \label{nthrootscomplexthm} \textbf{The \boldmath $n^{\mbox{\textbf{\scriptsize th}}}$ roots of a Complex Number:}
...
\input{ExercisesforPolarComplex}
