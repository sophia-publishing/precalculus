...
\opengraphsfile{HomeworkCompiler}

\setcounter{footnote}{0}

\section{Homework from somewhere}

\input{../IntroductiontoFunctions/ExercisesforFunctionsandtheirRepresentations}

\newpage

\section{A Different Set of Exercises}

\input{../RationalFunctions/ExercisesforRationalIneq}
