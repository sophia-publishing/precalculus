...
\arrow \reverse \arrow \parafcn{-1.11, 1.11,0.1}{(t**5+1,t**13)}
\point[4pt]{(0,-1), (1,0), (2,1)}
\xtcaption{$y=(x-1)^{2.6}$ with $(0,-1)$, $(1,0)$, $(2,1)$}
\end{mfpic}
...
\xtcaption{$F(x)=(2x-1)^{2.6}$ with $(0,-1)$, $\left(\frac{1}{2},0 \right)$, $(1,1)$}
\end{mfpic}
