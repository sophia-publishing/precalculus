...
&
\stackrel{\text{\parbox{.5in}{\centering \scriptsize add $-3$ to each $x$-coordinate}}}{\xrightarrow{\hspace{.5in}}}
&

\begin{mfpic}[13]{-7}{1}{-3}{3}
\axes
...
&
\stackrel{\text{\parbox{.5in}{\centering \scriptsize  multiply each $y$-value by $-2$}}}{\xrightarrow{\hspace{.5in}}}
&
...
&
\stackrel{\text{\parbox{.5in}{\centering \scriptsize  add $1$ to each $y$-value}}}{\xrightarrow{\hspace{.5in}}}
&
...
\end{mfpic}\\
%
\stackrel{\text{\parbox{1in}{\centering \scriptsize add $-1$ to each $t$-coordinate}}}{\xrightarrow{\hspace{1in}}}
\quad
%
...
\end{mfpic} \\
%
\transgraph{1in}{divide each $t$-coordinate by $-2$:}
\quad
%
\begin{adjustbox}{valign=c}
...
\end{mfpic}\\
%
\transgraph{1in}{multiply each $y$-coordinate by $\frac{1}{4}$:}
%
\begin{adjustbox}{valign=c}
...
\input{ExercisesforRootRadicalFunctions}
